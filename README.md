...
**`getCountAnalytics`**| Returns the number of clicks and total number of queries over a period.<br/> <br/> **Parameters :** <br />  - `$engineName` (required) <br />   - `$filters`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/analytics/counts)
...
**`getTopClicksAnalytics`**| Returns the number of clicks received by a document in descending order.<br/> <br/> **Parameters :** <br />  - `$engineName` (required) <br />   - `$query`<br />   - `$currentPage`<br />   - `$pageSize`<br />   - `$filters`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/analytics/clicks)
**`getTopQueriesAnalytics`**| Returns queries anlaytics by usage count.<br/> <br/> **Parameters :** <br />  - `$engineName` (required) <br />   - `$currentPage`<br />   - `$pageSize`<br />   - `$filters`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/analytics/queries)
