...
------------|-------------|--------------
**`createCredential`**| Create a new API key.<br/> <br/> **Parameters :** <br />  - `$name` (required) <br />   - `$type` (required) <br />   - `$read` (required) <br />   - `$write` (required) <br />   - `$accessAllEngines`<br />   - `$engines`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/credentials#create)
...
**`deleteCredential`**| Delete an API key.<br/> <br/> **Parameters :** <br />  - `$keyName` (required) <br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/credentials#delete)
...
**`getCredential`**| Retrieve details for one API key.<br/> <br/> **Parameters :** <br />  - `$keyName` (required) <br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/credentials#single)
...
**`listCredentials`**| Retrieve details for all keys.<br/> <br/> **Parameters :** <br />  - `$currentPage`<br />   - `$pageSize`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/credentials#all)
...
**`updateCredential`**| Update an existing API key.<br/> <br/> **Parameters :** <br />  - `$keyName` (required) <br />   - `$name` (required) <br />   - `$read` (required) <br />   - `$write` (required) <br />   - `$accessAllEngines`<br />   - `$engines`<br/>|[Endpoint Documentation](https://swiftype.com/documentation/app-search/api/credentials#update)
